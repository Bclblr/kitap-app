...
'Server-authoritative Premium access summary for the current authenticated user. Paid Apple/Google access and free admin grants are evaluated independently and combined only for effective Premium access.';
