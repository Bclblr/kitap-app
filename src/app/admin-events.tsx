...
const baseStyles = StyleSheet.create({
  ...
  cardTitle: { color: '#F5F5F8', fontSize: 16, fontWeight: '850' },
  ...
  openButtonText: { color: '#B6B6C3', fontSize: 11, fontWeight: '750' },
  ...
  actionText: { color: '#B6B6C3', fontSize: 10, fontWeight: '750' },
