...
const baseStyles = StyleSheet.create({
  ...
  eyebrow: { color: '#A985FF', fontSize: 12, fontWeight: '900', letterSpacing: 1.3 },
  ...
  step: { color: '#A985FF', fontSize: 12, fontWeight: '900' },
  ...
  profileHint: { marginTop: 12, color: '#737380', fontSize: 12, lineHeight: 18 },
  ...
  goalLabel: { marginTop: 2, color: '#737380', fontSize: 12, fontWeight: '700' },
