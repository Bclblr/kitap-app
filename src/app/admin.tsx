    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.footerNote}>
          Kullanıcı, içerik, moderasyon, hashtag, keşfet, kitap, yazar, topluluk ve etkinlik yönetimi aktif. Diğer yönetim modülleri sırayla panele bağlanacak.
        </Text>
      </ScrollView>
    </View>
  );
