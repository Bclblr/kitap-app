...
const baseStyles = StyleSheet.create({
  ...
  badge: { alignSelf: 'flex-start', color: '#B58AF6', backgroundColor: '#1D1728', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, fontSize: 12, fontWeight: '900', letterSpacing: 0.6 },
  ...
  infoLabel: { color: '#777983', fontSize: 12, fontWeight: '700', marginBottom: 5, textTransform: 'uppercase' },
  ...
  attendanceLabel: { color: '#8E8F98', fontSize: 12, marginTop: 2 },
